/*
	Semantic segmentation using the Deep Residual Learning (ResNet) with dlib implementation.
...
constexpr int class_count = 2; // background + 1 classes

//// A medical image data could contain multiple classes with a background (class 0). Each class
...
using net_type = dlib::loss_multiclass_log_per_pixel<
	...
	dlib::input<dlib::matrix<dlib::bgr_pixel>>
	>>>>>>>>>>>>>>;
